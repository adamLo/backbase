...
class WeatherPrecipationTests: XCTestCase {

    let jsonFile = "weatherprecipation"
    var json: [String: Any]?
    ...
    func testParsing() {
        ...
        let data = WeatherPrecipation(json: json!)
        
        XCTAssertNotNil(data.hour3)
        assert(data.hour3 == 0.123)
    }
